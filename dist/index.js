...
var SideBarion = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(SideBarion, [{
      ...
      if (menuItem.menuItems.length > 0) {
        return /*#__PURE__*/_react.default.createElement("ul", {
          ...
          return /*#__PURE__*/_react.default.createElement("li", {
            ...
            "data-user-menu": row.userData ? row.userData : '',
            style: {
              display: row.isShow === true ? "block" : "none"
            }
          }, row.isSelected ? row.href === undefined ? /*#__PURE__*/_react.default.createElement("div", {
            className: "ionLink"
          ...
          }, checkI.bind(_this4)(row, i), _this4.refreshImage(row), _this4.refreshContentHtml(row), _this4.refreshImageToggleMenu(row))) : /*#__PURE__*/_react.default.createElement(_reactRouterDom.Link, {
            to: row.href,
            className: "ionLink"
          }, /*#__PURE__*/_react.default.createElement("div", {
            className: _this4.getClassNameSubMenuItem(row),
    ...
    key: "renderLinc",
    value: function renderLinc(row, i) {
      if (row.href) {
        ...
        return /*#__PURE__*/_react.default.createElement("diw", {
          className: "ionLink"
        }, this.overlayTooltipMenu(row, i));
      }
    }
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_reactRouterDom.BrowserRouter, null, /*#__PURE__*/_react.default.createElement("div", {
        ...
        }, row.isSelected ? _this7.renderLinc(row, i) : _this7.overlayTooltipMenu(row, i), _this7.renderSubmenu(row));
      }))))), /*#__PURE__*/_react.default.createElement("div", {
        className: "hamburger",
        style: {
          cursor: "pointer",
